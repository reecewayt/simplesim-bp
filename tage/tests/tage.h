...
int bpred_dir_update_tage(struct bpred_dir_t *pred_dir, md_addr_t baddr, md_addr_t btarget, int taken, int pred_taken, char *dir_update_ptr); // updates TAGE predictor state based on actual outcome and prediction
